...
class DocumentDetailsDeleteScreen extends StatelessWidget {
...
class DocumentCard extends StatelessWidget {
  ...
  final bool isCompleted; // Add a flag to indicate if the document is completed

  DocumentCard({required this.document, this.isCompleted = false});
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: isCompleted ? Colors.green : Colors.transparent, // Use green for completed
                border: Border.all(color: Colors.blue),
              ),
              child: isCompleted
                  ? Icon(Icons.check, size: 16, color: Colors.white) // Checkmark for completed
                  : Container(), // Empty container for not completed
            ),
          ),
        ],
      ),
